...
import { MultiSelect, type MultiSelectOption } from '~/components/ui/multi-select/multi-select';
...
vi.mock('~/components/ui/select', () => ({
  Select: ({ children, onValueChange, disabled }: any) => (
    <div data-testid="select" data-disabled={disabled} data-onchange={onValueChange?.toString()}>
      {children}
    </div>
  ),
